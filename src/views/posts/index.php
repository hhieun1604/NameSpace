    ...
    <div class="px-1 pb-2">
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-8 ml-lg-auto text-md-right text-left">
            <form class="d-inline" method="post" action="<?= e_attr(url_for('dashboard.posts.actions_post')); ?>">
              <?= $t['csrf_html']; ?>
              <button type="submit" name="action" value="flush" class="btn btn-danger" data-toggle="tooltip" title="<?= e_attr(__('Deletes all the imported posts')); ?>"><?= svg_icon('trash', 'mr-1'); ?> <?= __('Empty Imported Posts'); ?></button>
            </form>
            <?php
            /**
