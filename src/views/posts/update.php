  ...
  <div class="col-md-8">
    <div class="px-lg-4 px-0">
      ...
      <div class="form-group">
        ...
        <input type="text" name="post_title" id="post_title" class="form-control" value="<?= sp_post('post_title', $t['post.post_title']); ?>" maxlength="200" required>
      </div>
      <div class="form-group">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="post_source" id="post_source" class="form-control" value="<?= sp_post('post_source', $t['post.post_source']); ?>" maxlength="200">
          <div class="form-text text-muted">
